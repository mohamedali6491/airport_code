...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.keyboard_info.KeyboardInfoPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin keyboard_info, com.example.keyboard_info.KeyboardInfoPlugin", e);
    }
    try {
